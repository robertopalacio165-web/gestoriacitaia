...
import { User, Bell, Menu, X, Home, LayoutDashboard, CalendarSearch, FileText } from "lucide-react";
    ...
    <>
      <header className="fixed top-0 w-full z-50 glass-panel-heavy border-b border-white/[0.07] transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3">
          ...
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2.5 group hover:opacity-85 transition-opacity shrink-0" onClick={() => setMobileOpen(false)}>
