...
إلا بغيتي نعاونك باش نverify الملف ديالك ديال التسوية الجماعية تبع معايا الخطوات.
...
"مزيان دابا نوبتك. غادي تسولني أربعة الأسئلة اللي بغيتي وأنا نجاوبك عليهم."

🎯 منين يكمل 4 أسئلة:

"دابا صيفط الوثائق ديالك كاملين. ومن بعد ضغط على Verify documentos."

🎯 منين يدير Verify:

شرح الملف كامل + واش قوي ولا ناقص

🎯 النهاية:

"دخل رقمك وغادي نصيفط لك الملف فالواتساب. شكراً على الثقة ديالك."
`;
...
const fullSpeech = `
دابا غادي نشرح ليك الملف ديالك مزيان.

${hasPassport ? "الباسبور ديالك باين ومزيان." : "ما عندكش باسبور واضح."}

${hasMonths ? "عندك 5 شهور متتابعين فإسبانيا." : "مازال ما كملتيش 5 شهور."}

الوثائق اللي صيفطتي باينين وكيساعدو الملف ديالك.

${finalVerdict}

دابا دير هاد الخطوة:
رفع جميع الوثائق ديالك (PDF ولا تصاور)، يكون فيهم الاسم والتاريخ واضح.

ومن بعد ورك على الزر ديال Verify Documentos باش نحللهم ليك كاملين.

ومن بعد غادي نصيفط لك الملف كامل فالواتساب.
`;
