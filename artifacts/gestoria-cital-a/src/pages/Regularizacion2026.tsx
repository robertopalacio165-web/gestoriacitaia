...
${docsWithData.map(doc => `الوثيقة: ${doc.nombre}
النوع: ${doc.detectedType || "غير معروف"}
التاريخ: ${doc.document_date || "غير موجود"}
النتيجة: ${doc.final_verdict || "غير معروفة"}
تاريخ الانتهاء: ${doc.expiry_date || "لا يوجد"}`).join("\n")}

حلل جميع التواريخ الموجودة.

احسب واش كاين 150 يوم متتابعين.

إلى كان شي فراغ بين الوثائق قول:

من تاريخ .... إلى تاريخ .... كاين فراغ مدته .... يوم.

قول واش هاد الفراغ كيقطع الاستمرارية ولا لا.

حلل كل وثيقة بوحدها.

قول واش وثيقة قوية ولا ضعيفة.

قول واش كتصلح لإثبات الوجود فإسبانيا ولا لا.

إذا كان الباسبور منتهي الصلاحية قول خاصو يتجدد.

إذا كانت وثيقة ديال الطرد حلل تاريخها وواش مازال فعالة.

إذا كانت وثيقة ديال البوليس حللها قانونياً.

إذا كان اللجوء حللو حسب القوانين الحالية.
...
الوثائق اللي رفعتي
الأوراق اللي عندك
الإثباتات اللي قدمتي

وفي الأخير قول:

أنا عطيتك التحليل ديال الوثائق اللي رفعتي حسب المعطيات اللي بانوا فيها. والله يسهل عليك فالمسار ديالك فالتسوية الجماعية. وإذا احتجتي أي حاجة تواصل مع GestoriaCitaIA.
`;
