  ...
  const handleVerifyAll = async () => {
    try {
      ...
      for (const doc of docs) {
        ...
        // ✅ expulsion check INSIDE the loop
        const docName = (doc.nombre || doc.detectedType || "").toLowerCase();
        if (docName.includes("expulsion") || docName.includes("expulsión") || docName.includes("asilo") || docName.includes("refugio") || docName.includes("retorno")) {
          hasExpulsion = true;
      ...
      setExpulsionVerified(!hasExpulsion || expulsionExpired);
      setSoufianeReady(hasPassport && hasMonths && (!hasExpulsion || expulsionExpired));
