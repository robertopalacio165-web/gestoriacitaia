      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Sara ha encontrado una cita oficial para ti.
            Revisa todos los datos antes de continuar
            con la reserva segura.
          </p>
          ...
          {hasRealData ? (
            ...
            <div className="p-10 text-center">
              ...
              <p className="mt-3 text-slate-400 max-w-lg mx-auto leading-relaxed">
                Este enlace no contiene información
                completa o la reserva ya no está disponible.
              </p>
