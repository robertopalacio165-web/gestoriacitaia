...
<div className="mb-3">
  ...
  {/* ✅ DESPUÉS DEL PAGO = FOTO REALTIME */}
  {isPaid && (
    <>
      <img
      ...
      <div className="absolute bottom-5 left-5">
        <button
          ...
          className={`w-16 h-16 rounded-full flex items-center justify-center border border-white/20 shadow-2xl transition-all ${
            isListening
              ? "bg-red-500"
              : "bg-green-500"
          }`}
