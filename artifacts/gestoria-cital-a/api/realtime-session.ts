...
ولكن قبل، خاصك تكمل الأداء ديالك عاد باش نبداو.
  ...
  const handleSendWhatsApp = async () => {
    try {
      ...
      // Construir mensaje con el resultado del análisis
...
📅 حساب المدة:
إذا كانت الوثائق فيها تواريخ، رتبهم زمنياً واحسب الأيام بين أول وآخر تاريخ.

✅ إذا كانت التغطية أكثر من 5 شهور متواصلة (150 يوم):
قول: "الوثائق كيبان منهم أنك كنت حاضر فإسبانيا أكثر من 5 شهور متواصلة."

❌ إذا كان كاين فراغ:
قول: "كاين فراغ فالفترة الزمنية وخصنا وثائق إضافية."

🚫 تحليل الطرد:
إذا كان القرار ديال الطرد، استخرج الدولة والتاريخ ومدة المنع.
إذا كان المنع مازال ساري: "حالياً المنع مازال ساري."
إذا كان سالى: "المنع سالى وما كيأثرش على الملف."

📊 النتيجة النهائية (هذا هو المهم):

إذا كان الملف كامل:
"✅ الملف ديالك كامل ومقبول. عندك ${analysisResult.days} يوم ديال الإقامة. دابا خاصك تدخل رقم هاتفك فالمربع ديال واتساب وتضغط على زر الإرسال باش توصلك الوثيقة المهمة ف جوالك."
...
`;
          ...
          if (msg.type === "response.done") {
            ...
            // Marcar que Soufiane ya habló y desactivar el micrófono
  ...
  const handleVerifyAll = async () => {
    try {
      ...
      // Construir mensaje para Soufiane
      let mensajeSoufiane = "";
...
`;
      ...
      // Conectar y hablar UNA SOLA VEZ
